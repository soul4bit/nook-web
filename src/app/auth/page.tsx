        ...
        <section className="flex flex-col justify-between border-b border-slate-200 bg-[#f2f6fa] p-6 lg:border-b-0 lg:border-r lg:p-8 xl:p-10">
          <div>
            <div className="flex items-center gap-4">
              <div className="relative flex h-14 w-20 items-center justify-center overflow-hidden rounded-[20px] border border-[#bfcede] bg-white">
                <div className="absolute left-2 h-3 w-2 rounded-full bg-[#3b82a4]" />
                <div className="absolute left-6 top-4 h-7 w-4 rounded-l-[20px] rounded-r-[6px] bg-[#3b82a4]" />
                <div className="absolute left-8 top-2 h-10 w-3 rotate-[32deg] rounded-full bg-[#3b82a4]" />
                <div className="absolute right-6 top-4 h-7 w-4 rounded-l-[6px] rounded-r-[20px] bg-[#3b82a4]" />
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">Вход в личную базу знаний</p>
              </div>
            </div>
